...
`../asu-guide/public/mark.png` — a gold brain struck by a maroon lightning bolt, used in the empty state and side nav. Generated on AIR with `flux-2` (512×512), background keyed out.
