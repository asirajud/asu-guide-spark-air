        ...
        <div className="overflow-hidden rounded-lg border border-asu-line bg-white shadow-sm">
          <div className="border-b-4 border-[#C77700] bg-[#FFF4D6] px-6 py-4 text-[#7A4A00]">
            ...
            <p className="mt-1 text-[13px] font-semibold leading-snug">
              This is a mock sign-in for the ASU AIR Spark Challenge. It is NOT a real ASU login.
              Do not enter your real ASURITE password.
            </p>
          </div>
          <div className="px-6 py-7">
            <h2 className="text-[26px] font-bold text-asu-ink">Sign In</h2>
            <p className="mt-1 text-[13px] text-asu-muted">{props.clientName} is requesting access to your demo profile.</p>
            {props.error && (
            ...
            <form method="post" action="/api/login" className="mt-6 space-y-5">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[12px] text-asu-muted">
                  Any value is accepted — this is a demo. Try <span className="font-mono">asirajud</span>.
                </p>
              </div>
              <div>
            ...
            <div className="mt-6 flex flex-wrap gap-x-5 gap-y-2 border-t border-asu-line pt-4 text-[12px] text-asu-muted">
              <span className="cursor-default underline decoration-dotted underline-offset-2" title="Inactive — demo page">Forgot ASURITE ID?</span>
              <span className="cursor-default underline decoration-dotted underline-offset-2" title="Inactive — demo page">Activate ASURITE</span>
              <span className="cursor-default underline decoration-dotted underline-offset-2" title="Inactive — demo page">Help</span>
              <span className="cursor-default underline decoration-dotted underline-offset-2" title="Inactive — demo page">Privacy</span>
            </div>
          </div>
        </div>
      </main>
      <p className="mt-6 text-center text-[12px] leading-relaxed text-asu-muted">
        Mock OAuth 2.0 identity provider built for the ASU AIR Spark Challenge. No credentials are checked and nothing is stored beyond this process's memory. Not affiliated with, endorsed by, or connected to Arizona State University's real sign-in service.
      </p>
    </>
  );
}